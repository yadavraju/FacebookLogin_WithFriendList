package com.raju.facebookproject.adapter;
...
import com.raju.facebookproject.ui.friendsList.FriendDetailActivity;
...
public class FriendsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class FriendViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view) {
            ...
            Constants.USER__DETAIL_DATA = friendsList.get(getLayoutPosition());
            //intent.putExtra(Constants.USER_DATA, friendsList.get(getLayoutPosition()));
